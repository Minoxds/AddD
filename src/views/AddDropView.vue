...
<template>
    <div class="container mt-5 text-center">
        ...
        <div class="mt-5 text-end" v-if="select.length >= 3">
            ...
            <button class="btn btn-danger me-3" @click="restart">ล้างที่เลือก</button>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="selectSubjectToggleLabel">เลือกรายวิชาที่ต้องการ</h1>
    ...
    <div class="modal fade" id="confirm" aria-hidden="true" aria-labelledby="confirmToggleLabel" tabindex="-1">
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container text-center">
                        <div class="row" style="font-size: 22px; color:darkgreen;">
                            <div class="col">
                                <div>รหัสวิชา</div>
                            </div>
                            <div class="col">
    ...
    <div class="modal fade" id="finish" aria-hidden="true" aria-labelledby="finishToggleLabel2" tabindex="-1" @click="this.$router.go(0);">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-body text-center" style="font-size: larger; color:green;">
                successfully
              </div>
          </div>
        </div>
